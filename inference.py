...
def prepare_comment(comment, tokenizer, max_length=30, trunc_type='post', print_sequence=False):
...
if __name__ == '__main__':
    ...
    prepared_comment = prepare_comment(comment, tokenizer, max_length=30, trunc_type='post')
